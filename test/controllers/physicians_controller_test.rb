...
class PhysiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post physicians_url, params: { physician: { Name: @physician.Name, Specialty: @physician.Specialty } }
    end
  ...
  test "should update physician" do
    patch physician_url(@physician), params: { physician: { Name: @physician.Name, Specialty: @physician.Specialty } }
